...
function o(e, a, n, r, c=1) {
    t.fillStyle = `rgba(${[0].reduce(((e,t)=>e.slice((c - 1) % 3).concat(e.slice(0, (c - 1) % 3))), [25, 255 * s(i.a, a / 500), 25])}, 255)`,
    t.fillRect(e, a, n, r)
}
function y() {
    ...
    i.c.some((e=>1 === e))) {
        ...
        i.j >= 64 && (i.i.push((63 & i.j) - 32),
        i.j = 1),
        i.k = i.k + 211 * (i.g.x + 9) * (i.g.y + 9) * 239 & 4294967295,
        16 == i.i.length && 1 === i.j && i.e.push("1,6,11,16" == (e = [...Array(4).keys()].map((e=>i.i.slice(4 * e, 4 * e + 4))),
        t = a[i.b],
        ...
        i.g.x === i.f.x - 9 && i.g.y === i.f.y - 9 && (i.g.x = -7,
        i.g.y = -7,
        i.i = [],
        i.j = 1,
        i.k = 0,
...
function l() {
    ...
    [...Array(i.f.y).keys()].forEach((e=>{
        [...Array(i.f.x).keys()].forEach((t=>{
            ...
            0 != (1 & i.f.z[e][t]) && o(40 * (t - i.g.x), 40 * (e - i.g.y), 1, 40)
        }
        ))
    }
    )),
...
function f(e) {
    i.f.z = [...Array(i.f.y).keys()].map((t=>[...Array(i.f.x - 1).keys()].reduce(((a,n)=>t > 0 && t < i.f.x - 1 && c(23 * n + 7 * t + 3 * e) > .5 == 0 ? [[...a[0].slice(0, a[1] + Math.floor(c(17 * n + 9 * t + 3 * e) * (n - a[1] + 1))), 1 | a[0][a[1] + Math.floor(c(17 * n + 9 * t + 3 * e) * (n - a[1] + 1))], ...a[0].slice(a[1] + Math.floor(c(17 * n + 9 * t + 3 * e) * (n - a[1] + 1)) + 1)], n + 1] : [[...a[0].slice(0, n), 2 | a[0][n], ...a[0].slice(n + 1)], a[1]]), [t < i.f.x - 1 ? [1, ...new Array(i.f.x - 2).fill(0), 1] : new Array(i.f.x).fill(0), 0]))).map((e=>e[0])),
